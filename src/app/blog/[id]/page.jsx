...
export default function BlogDetails(ctx) {
  ...
  useEffect(() => {
    async function fetchComments() {
      const res = await fetch(`https://nextjs-blog-3r517no3p-tyestanley.vercel.app/api/comment/${ctx.params.id}`, {
        cache: "no-store"
      });
  ...
  useEffect(() => {
    async function fetchBlog() {
      const res = await fetch(`https://nextjs-blog-3r517no3p-tyestanley.vercel.app/api/blog/${ctx.params.id}`, {
        cache: "no-store"
      });
  ...
  async function handleLike() {
    try {
      const res = await fetch(`https://nextjs-blog-3r517no3p-tyestanley.vercel.app/api/blog/${ctx.params.id}/like`, {
        headers: {
  ...
  async function handleComment() {
    ...
    try {
      ...
      const res = await fetch("https://nextjs-blog-3r517no3p-tyestanley.vercel.app/api/comment", {
        headers: {
